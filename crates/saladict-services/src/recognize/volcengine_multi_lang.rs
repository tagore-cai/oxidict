//! 火山引擎多语种 OCR。
//!
//! 移植自 `src/services/recognize/volcengine_multi_lang/index.jsx`。
//! 与 `volcengine` 同签名流程，仅 action 为 `MultiLanguageOCR`、版本 `2022-08-31`，
//! 响应取 `data.ocr_infos[].text` 拼接。
...
pub struct VolcengineMultiLang;
...
#[async_trait]
impl Recognizer for VolcengineMultiLang {
    fn id(&self) -> &str {

## Generated from zh_TW.json (fallback: en-US)
...
updater-latest-version = ## 已安裝最新版本
updater-title = 檢查更新
...
tray-copy-source = 原文
tray-copy-target = 譯文
tray-copy-source-target = 原文+譯文
tray-copy-disable = 關閉

## Generated from pt_BR.json (fallback: en-US)
...
updater-title = Checar por Atualização
...
tray-copy-disable = Desabilitar
tray-check-update = Checar por Atualização
tray-view-log = Exibir Registro

...
impl UpdaterWindow {
    ...
    fn check_update(&mut self, _: &ClickEvent, _: &mut Window, cx: &mut Context<Self>) {
        ...
        // TODO: GitHub 仓库建好后改为实际地址（当前为占位，检查更新会 404 并显示"已是最新"）。
        let url = "https://api.github.com/repos/oxidict/oxidict/releases/latest".to_string();
                        ...
                        h_flex().justify_end().child(
                            Button::new("download")
                                ...
                                .on_click(cx.listener(|_, _, _, cx| {
                                    cx.open_url(
                                        "https://github.com/oxidict/oxidict/releases/latest",
                                    );
                                })),
                        ),
                    ),
